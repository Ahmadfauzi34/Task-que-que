...
printf 'public workflow cancel          : EXECUTED\n'
printf 'parent terminal state           : CANCELLED\n'
printf 'parent fence                    : REVOKED\n'
printf 'heartbeat after revoke          : REJECTED\n'
printf 'generic AbortSignal             : DELIVERED\n'
printf 'workflow orchestration          : ABORTED\n'
printf 'post-cancel child enqueue       : NOT STARTED\n'
printf 'parent result projection        : NOT WRITTEN\n'
printf 'existing child autonomy         : PRESERVED\n'
