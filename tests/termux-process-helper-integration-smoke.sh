...
printf 'Registered process scoped-authority integration proof state\n'
printf 'registry schema                         : V2\n'
printf 'D5/A1 exact-scope read-only command    : OK\n'
printf 'A1 -> A3 mutating command              : REJECTED PRE-EXEC\n'
printf 'D5/A3 exact-scope mutating command     : OK\n'
...
printf 'MCP process projection                 : PROVEN SEPARATELY\n'
printf '\nRegistered process scoped authority integration: OK\n'
